...
try:
    ...
    # Wrap HTML in proper XML structure for Odoo (no XML declaration for unicode strings)
    xml_arch = f'<div><![CDATA[{homepage_html}]]></div>'
    ...
    if page_ids:
        ...
        print("  [OK] Homepage page found, updating...")
        models.execute_kw(DB, uid, PASSWORD, 'website.page', 'write',
            [page_ids[0]],
            {'arch': xml_arch}
        )
        print("  [OK] Homepage updated successfully!")
    else:
        # Create new page
        print("  [OK] Creating new homepage page...")
    ...
    print("  [OK] Professional header with navigation")
    print("  [OK] Hero section with featured product")
    print("  [OK] Features section (Free Gifts, Shipping, etc.)")
    print("  [OK] Category showcase (Sports, Pokemon, MTG, etc.)")
    print("  [OK] Special sections (Live Breaks, Deals, etc.)")
    print("  [OK] New Releases product grid")
    print("  [OK] Professional footer")
    print("  [OK] Responsive mobile design")
    print("  [OK] Real images from Unsplash")
    print()
    print("CUSTOMIZATION:")
